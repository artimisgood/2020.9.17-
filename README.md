# 2020.9.17补的题目————寻找两个正序数组的中位数
## 题目 
定两个大小为 m 和 n 的正序（从小到大）数组 nums1 和 nums2。
...
java
### 思路
[视频教程](https://leetcode-cn.com/problems/median-of-two-sorted-arrays/solution/xun-zhao-liang-ge-you-xu-shu-zu-de-zhong-wei-s-114/) 
### 代码
```java
class Solution {
